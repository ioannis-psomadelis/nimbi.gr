...
export const Route = createFileRoute('/en/pro/observatory/$slug')({
  beforeLoad: ({ params }) => {
  ...
  head: ({ loaderData }) => {
    ...
    const url = `https://nimbi.gr/en/pro/observatory/${slug}`
    const canonicalUrl = `https://nimbi.gr/en/observatory/${slug}`
  ...
  component: EnglishProObservatoryPageRoute,
})

function EnglishProObservatoryPageRoute() {
